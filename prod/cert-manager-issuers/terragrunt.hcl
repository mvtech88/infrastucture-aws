...
inputs = {
  ...
  enable_cert-manager-issuers      = include.prod.locals.cert-manager-issuers
  cert-manager-issuers_helm_version = include.prod.locals.cert-manager-issuers_helm_version 
}
